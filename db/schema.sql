...
CREATE TABLE IF NOT EXISTS `user_folder` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_user_folder_active_name` (`user_id`,`parent_id`,`folder_name`,`active_key`),
...
CREATE TABLE IF NOT EXISTS `user_file` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_user_file_storage_path` (`storage_path`),
